    ...
    def machine(self):
        ...
        if isExists == True:
            ...
            if exists(join(getcwd(),'saved_models', 'ada_class.sav')) == False:
                ada_class = AdaBoostRegressor(**self.hyper_param_dict['Ada']).fit(self.x_train,self.y_train) #THIS IS WRONG IM DOUBLY FITTING THE DATA TO THE TRAIN AND TEST DATA LOL
